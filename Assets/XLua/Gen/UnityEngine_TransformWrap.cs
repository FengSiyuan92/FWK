...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 26, 19, 13);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "MoveLocalPos", _m_MoveLocalPos);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "MovePos", _m_MovePos);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "ScaleTo", _m_ScaleTo);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "RotateToLocal", _m_RotateToLocal);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_MoveLocalPos(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.MoveLocalPos( _x, _y, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 5);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.MoveLocalPos( _x, _y, _z, _duration );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.MoveLocalPos!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_MovePos(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.MovePos( _x, _y, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 5);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.MovePos( _x, _y, _z, _duration );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.MovePos!");
        ...
        static int _m_ScaleTo(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.ScaleTo( _x, _y, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 5);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.ScaleTo( _x, _y, _z, _duration );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.ScaleTo!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_RotateToLocal(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.RotateToLocal( _x, _y, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 5);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.RotateToLocal( _x, _y, _z, _duration );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.RotateToLocal!");
        ...
        static int _m_RotateTo(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 4);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.RotateTo( _x, _y, _duration );
                        translator.Push(L, gen_ret);
                ...
                if(gen_param_count == 5&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)) 
                {
                    ...
                    float _duration = (float)LuaAPI.lua_tonumber(L, 5);
                        ...
                        FAction.TransformToAction gen_ret = gen_to_be_invoked.RotateTo( _x, _y, _z, _duration );
                        translator.Push(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Transform.RotateTo!");
