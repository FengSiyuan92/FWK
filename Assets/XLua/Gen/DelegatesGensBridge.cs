...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp2(double p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp3(UnityEngine.Texture p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<double>(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(System.Action<UnityEngine.Texture>))
			{
			    return new System.Action<UnityEngine.Texture>(__Gen_Delegate_Imp3);
			}
			...
			{
			    return new UnityEngine.Events.UnityAction(__Gen_Delegate_Imp10);
			}
