...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(FAction.Action), FActionActionWrap.__Register);
...
namespace XLua
{
	...
	internal partial class InternalGlobals
    {
		...
		delegate FAction.GraphicToAction __GEN_DELEGATE0( UnityEngine.UI.Graphic graphic,  float r,  float g,  float b,  float duration);
		
		delegate FAction.GraphicToAction __GEN_DELEGATE1( UnityEngine.UI.Graphic graphic,  float a,  float duration);
		
		delegate FAction.GraphicToAction __GEN_DELEGATE2( UnityEngine.UI.Graphic graphic,  float r,  float g,  float b,  float a,  float duration);
	    ...
	    static InternalGlobals()
		{
		    extensionMethodMap = new Dictionary<Type, IEnumerable<MethodInfo>>()
			{
				...
				{typeof(UnityEngine.UI.Graphic), new List<MethodInfo>(){
				  ...
				  new __GEN_DELEGATE0(FAction.Action.ColorTo)
				  ...
				  new __GEN_DELEGATE1(FAction.Action.AlphaTo)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
				  ...
				  new __GEN_DELEGATE2(FAction.Action.ColorTo)
#if UNITY_WSA && !UNITY_EDITOR
                                      .GetMethodInfo(),
#else
                                      .Method,
