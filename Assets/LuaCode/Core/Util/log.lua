...
function LogObj(msg,obj)
	...
	CS.Logger.Log(debug.traceback(msg, 2),obj)
end
...
function LogErrorObj(msg,obj)
	CS.UnityEngine.Debug.LogError(debug.traceback(msg, 2),obj)
end
...
function LogWarning(msg)
	...
	CS.Logger.LogWarning(debug.traceback(msg, 2))
end
...
function LogRed(str)
	...
	CS.Logger.Log(debug.traceback(string.format("<color=Red>%s</color>",str),2))
end
