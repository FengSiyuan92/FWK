...
namespace UnityEngine.UI.Extensions
{
    ...
    public class UIPolygon : UIPrimitiveBase
    {
        ...
        public void DrawPolygonByVertices(float[] _VerticesDistances, float _rotation)
        {
            sides = _VerticesDistances.Length;
            VerticesDistances = new float[sides+1];
            for (int i = 0; i < sides; i++) VerticesDistances[i] = _VerticesDistances[i];
