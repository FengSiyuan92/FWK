...
namespace UnityEngine.UI.Extensions
{
    ...
    public class SoftMaskScript : MonoBehaviour
    {
        ...
        void SetMask()
        {
         ...
         /*   var croppedTexture = new Texture2D((int)AlphaMask.rect.width, (int)AlphaMask.rect.height);
            var pixels = AlphaMask.texture.GetPixels((int)AlphaMask.textureRect.x,
                                                    (int)AlphaMask.textureRect.y,
                                                    (int)AlphaMask.textureRect.width,
                                                    (int)AlphaMask.textureRect.height);
